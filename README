...
The support forum is [here](https://github.com/fauna/sweeper/issues).
...
* The source for the LasFM Fingerprinter: https://github.com/lastfm/Fingerprinter (if you need to build it from source)
